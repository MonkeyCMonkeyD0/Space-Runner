...
bool cmp(std::pair<unsigned long long int, unsigned int> & a, std::pair<unsigned long long int, unsigned int> & b)
{
...
unsigned int population, double survival_rate, unsigned int max_iteration) : 
																								weights(weights),
					profits(profits),
